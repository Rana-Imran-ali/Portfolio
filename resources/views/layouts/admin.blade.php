    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="flex-1 overflow-y-auto p-4">
            ...
            $links = [
                ...
                ['admin.chat.*', route('admin.chat.index'), 'Live Chat', '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z"/>'],
            ];
            @endphp
