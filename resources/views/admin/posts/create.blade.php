...
<div class="max-w-4xl mx-auto">
    <h1 class="text-3xl font-bold tracking-tighter mb-10">Create New Post</h1>
    ...
    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="content" rows="12" required class="w-full border border-gray-100 bg-gray-50 rounded-lg p-4 focus:outline-none focus:ring-2 focus:ring-black"></textarea>
        </div>
        <div>
        ...
        <div class="pt-6">
            <button type="submit" class="bg-black text-white px-8 py-4 rounded-md text-lg font-bold hover:bg-gray-800 transition-all w-full">Publish Post</button>
        </div>
    </form>
</div>
@endsection
